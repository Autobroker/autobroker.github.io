...
<p>Цена в Германии без НДС (цена нетто) авто с объемом <strong><em>1,5 литра</em></strong> &nbsp;10 000 Евро + 300 Евро сопровождение + 250 Евро покупка без НДС (12% от НДС) + 1800 &euro; перегон + 2550 &euro; пошлина полная ставка  = 10 000 <strong>+ <em>4900</em></strong> = 14 900 &euro;.</p>
